...
function themeColorLevel() {
  ...
  if (level < 0) {
    ...
    return polished.mix(level * -1 * themeColorInterval, colorBase, color);
  }

  return polished.mix(level * themeColorInterval, colorBase, color);
}
...
function borderRadius$1() {
  ...
  if (enableRounded) {
    return styledComponents.css(_templateObject, radius);
  }
...
function borderTopRadius(radius) {
  if (enableRounded) {
    return styledComponents.css(_templateObject2, radius, radius);
  }
}

function borderRightRadius(radius) {
  if (enableRounded) {
    return styledComponents.css(_templateObject3, radius, radius);
  }
}

function borderBottomRadius(radius) {
  if (enableRounded) {
    return styledComponents.css(_templateObject4, radius, radius);
  }
}

function borderLeftRadius(radius) {
  if (enableRounded) {
    return styledComponents.css(_templateObject5, radius, radius);
  }
}
...
var hover = function hover(content) {
  return styledComponents.css(_templateObject$1, content);
};

var hoverFocus = function hoverFocus(content) {
  if (enableHoverMediaQuery) {
    return styledComponents.css(_templateObject2$1, content, hover(content));
  }

  return styledComponents.css(_templateObject3$1, content);
};

var plainHoverFocus = function plainHoverFocus(content) {
  if (enableHoverMediaQuery) {
    return styledComponents.css(_templateObject4$1, content, hover(content));
  }

  return styledComponents.css(_templateObject5$1, content);
};

var hoverFocusActive = function hoverFocusActive(content) {
  if (enableHoverMediaQuery) {
    return styledComponents.css(_templateObject6, content, hover(content));
  }

  return styledComponents.css(_templateObject7, content);
};
...
function boxShadow(shadow) {
  if (enableShadows) {
    return styledComponents.css(_templateObject$2, shadow);
  }
...
var transition = function transition(transitionType) {
  if (enableTransitions) {
    return styledComponents.css(_templateObject$3, transitionBase);
  }

  return styledComponents.css(_templateObject2$2, transitionType);
};
...
function gradientStriped() {
  ...
  return styledComponents.css(_templateObject$4, angle, color, color, color);
}

exports.theme = defaultTheme;
exports.colorYiq = colorYiq;
exports.getColor = getColor;
exports.themeColor = themeColor;
exports.themeColorLevel = themeColorLevel;
