...
import { darken, lighten, parseToRgb, rgba, stripUnit } from 'polished';
...
function borderRadius$1() {
  ...
  if (enableRounded) {
    return css(_templateObject$2, radius);
  }
...
function boxShadow(shadow) {
  if (enableShadows) {
    return css(_templateObject$3, shadow);
  }
...
var hoverFocus = function hoverFocus(content) {
  if (enableHoverMediaQuery) {
    return css(_templateObject2$3, content, hover(content));
  }

  return css(_templateObject3$3, content);
};
...
function buttonVariant(background, border) {
  var activeBackground = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : darken(0.075, background);
  var activeBorder = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : darken(0.1, border);
...
function buttonOutlineVariant(color) {
  ...
  return css(_templateObject2$1, color, color, hover(css(_templateObject3$1, colorHover, color, color)), sassRgba(color, 0.5), color, colorHover, color, color);
}

function buttonSize(paddingY, paddingX, fontSize, lineHeight, radius) {
  return css(_templateObject4$1, paddingY, paddingX, fontSize, lineHeight, borderRadius$1(radius));
}
...
var transition = function transition(_transition) {
  if (enableTransitions) {
    return css(_templateObject$5, transitionBase);
  }

  return css(_templateObject2$4, _transition);
};
...
var Button$1 = styled.button(_templateObject, function (props) {
  ...
  return props.color === 'link' && css(_templateObject2, props.theme.fontWeightNormal, props.theme.linkColor, boxShadow('none'), hover('border-color: transparent;'), hoverFocus(css(_templateObject3, props.theme.linkHoverColor, props.theme.linkHoverDecoration)), btnLinkDisabledColor, hoverFocus('text-decoration: none;'));
}, function (_ref2) {
  ...
  return props.active && css(_templateObject4, boxShadow(props.theme.btnFocusBoxShadow));
}, function (props) {
  return props.block && css(_templateObject5);
});
